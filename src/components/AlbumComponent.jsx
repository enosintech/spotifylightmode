...
function AlbumComponent(props) {
  return (
        <div className={`w-[95%] min-h-[17%] mt-1 ${props.theme === "dark" ? "text-white hover:bg-[rgb(51,51,51)]" : "hover:bg-gray-200 text-black"} cursor-pointer flex items-center px-1 rounded-lg`}>
